...
function Projects() {
  ...
  return (
    <section className="mt-10">
      ...
      {/* complete projects */}
      <section className="mt-[2rem] columns-1 md:columns-2 lg:columns-3 gap-4 relative">
        <img src={Dots} className="w-[5rem] absolute -left-[9rem] top-[10rem] lg:block md:block hidden" alt="Dots pattern" />
